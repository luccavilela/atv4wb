...
public class WbbackendApplication {
	...
	public static class Runner implements ApplicationRunner {
		...
		public void run(ApplicationArguments args) throws Exception {
			...
			cliente.setNome("asasfdadafddasfdsad");
			cliente.setSobreNome("asfafdafdafgasfgaefesafsadfdsadfsadfdsdad");
			...
			cliente2.setNome("Teresa CrisafdasddfgdsagddasgfsaBourbon-Duas Sicílias");
